...
class testPython(unittest.TestCase):
    ...
    def test_wronganswer(self):
        ...
        self.driver.find_element_by_id("input").send_keys("0")
        self.driver.find_element_by_id("submit-btn").click()
        self.tryagain_alert = self.driver.switch_to.alert
        self.assertEqual('try again!', self.tryagain_alert.text, msg='fail')
        time.sleep(2)
        self.tryagain_alert.accept()
        time.sleep(2)
